...
func TestGalois(t *testing.T) {
	...
	galMulSlice(25, in, out, defaultOptions)
	...
	galMulSliceXor(52, in, out, defaultOptions)
	if 0 != bytes.Compare(out, expectXor) {
		t.Errorf("got %#v, expected %#v", out, expectXor)
	}

	galMulSlice(177, in, out, defaultOptions)
	...
	galMulSliceXor(117, in, out, defaultOptions)
	if 0 != bytes.Compare(out, expectXor) {
		t.Errorf("got %#v, expected %#v", out, expectXor)
	}
