...
TEXT ·galMulAVX512XorParallel44(SB), 7, $0
	...
	MOVQ low+0(FP), SI
	MOVQ high+24(FP), DX
	LONG $0x00000000 // VBROADCASTI64X2 ZMM14, [rsi]
	LONG $0x00000000 // VBROADCASTI64X2 ZMM15, [rdx]

	// MULTABLE(low2+240(FP), high2+264(FP), XLO2, XHI2, LO2, HI2)
	MOVQ low2+240(FP), SI
	MOVQ high2+264(FP), DX
	LONG $0x00000000 // VBROADCASTI64X2 ZMM12, [rsi]
	LONG $0x00000000 // VBROADCASTI64X2 ZMM13, [rdx]

	// MULTABLE(low3+288(FP), high3+312(FP), XLO3, XHI3, LO3, HI3)
	MOVQ low3+288(FP), SI
	MOVQ high3+312(FP), DX
	LONG $0x00000000 // VBROADCASTI64X2 ZMM10, [rsi]
	LONG $0x00000000 // VBROADCASTI64X2 ZMM11, [rdx]

	// MULTABLE(low4+336(FP), high4+360(FP), XLO4, XHI4, LO4, HI4)
	MOVQ low4+336(FP), SI
	MOVQ high4+360(FP), DX
	LONG $0x00000000 // VBROADCASTI64X2 ZMM16, [rsi]
	LONG $0x00000000 // VBROADCASTI64X2 ZMM17, [rdx]

	// MULMASK
	MOVQ         $15, BX
	MOVQ         BX, X5
	LONG $0x00000000 // VPBROADCASTB ZMM9, XMM5
...
loopback_xor_avx512_parallel44:
	// VMOVDQU (SI), Y0
	LONG $0x00000000 // VMOVDQU64 ZMM0, [rsi]
	VMOVDQU (AX), Y1
	LONG $0x00000000 // VMOVDQU64 ZMM1, [rax]
	VMOVDQU (BX), Y2
	LONG $0x00000000 // VMOVDQU64 ZMM2, [rbx]
	VMOVDQU (R11), Y3
	LONG $0x00000000 // VMOVDQU64 ZMM3, [r11]

	// VMOVDQU (DX), Y4
	LONG $0x00000000 // VMOVDQU64 ZMM4, [rdx]
	// VMOVDQU (CX), Y5
	LONG $0x00000000 // VMOVDQU64 ZMM5, [rcx]
	// VMOVDQU (R10), Y6
	LONG $0x00000000 // VMOVDQU64 ZMM6, [r10]
	LONG $0x00000000 // VMOVDQU64 ZMM18, [r12]

	// GFMULLXOR(Y0, LO1, HI1, Y4)
	LONG $0x00000000 // VPSRLQ   ZMM20, ZMM0, 4     ; Z1: high input
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM0, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM14, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM15, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	LONG $0x00000000 // VPXORQ   ZMM4, ZMM4, ZMM19

	// GFMULLXOR(Y1, LO1, HI1, Y4)
	LONG $0x00000000 // VPSRLQ   ZMM20, ZMM1, 4     ; Z1: high input
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM1, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM14, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM15, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	...
	// GFMULLXOR(Y2, LO1, HI1, Y4)
	LONG $0x00000000 // VPSRLQ   ZMM20, ZMM2, 4     ; Z1: high input
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM2, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM14, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM15, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	...
	// GFMULLXOR(Y3, LO1, HI1, Y4)
	LONG $0x00000000 // VPSRLQ   ZMM20, ZMM3, 4     ; Z1: high input
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM3, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM14, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM15, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	...
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM0, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM12, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM13, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	LONG $0x00000000 // VPXORQ   ZMM5, ZMM5, ZMM19
	...
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM0, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM10, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM11, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	LONG $0x00000000 // VPXORQ   ZMM6, ZMM6, ZMM19
	...
	LONG $0x00000000 // VPANDQ   ZMM19, ZMM0, ZMM9  ; Z0: low input
	LONG $0x00000000 // VPANDQ   ZMM20, ZMM20, ZMM9  ; Z1: high input
	LONG $0x00000000 // VPSHUFB  ZMM19, ZMM16, ZMM19  ; Z2: mul low part
	LONG $0x00000000 // VPSHUFB  ZMM20, ZMM17, ZMM20  ; Z3: mul high part
	LONG $0x00000000 // VPXORQ   ZMM19, ZMM19, ZMM20  ; Z4: Result
	LONG $0x00000000 // VPXORQ   ZMM18, ZMM18, ZMM19
	...
	// VMOVDQU Y4, (DX)
	LONG $0x00000000 // VMOVDQU64 [rdx], ZMM4
	// VMOVDQU Y5, (CX)
	LONG $0x00000000 // VMOVDQU64 [rcx], ZMM5
	// VMOVDQU Y6, (R10)
	LONG $0x00000000 // VMOVDQU64 [r10], ZMM6

	LONG $0x00000000 // VMOVDQU64 [r12], ZMM18
